...
#
# See https://github.com/PikeEcosystem/wasmvm/issues/222#issuecomment-880616953 for two approaches to
...
# We cannot use symlinks as those are not reliably resolved by `go get` (https://github.com/PikeEcosystem/wasmvm/pull/235).
